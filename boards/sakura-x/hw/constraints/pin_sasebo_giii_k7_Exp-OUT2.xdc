...
create_clock -period 41.666 -name lbus_clkn [get_ports lbus_clkn]
...
#NET "clk_kintex"  LOC="AB2"  |IOSTANDARD=LVCMOS15;

set_property PACKAGE_PIN AB2 [get_ports clk_kintex]
set_property IOSTANDARD LVCMOS15 [get_ports clk_kintex]
...
add_cells_to_pblock [get_pblocks pblock_CPU] [get_cells CPU_Comp/CPU/*]
add_cells_to_pblock [get_pblocks pblock_CPU] [get_cells CPU_Comp/CPU/main_memory/*]
add_cells_to_pblock [get_pblocks pblock_CPU] [get_cells CPU_Comp/CPU]
resize_pblock [get_pblocks pblock_CPU] -add {SLICE_X20Y150:SLICE_X55Y199}
resize_pblock [get_pblocks pblock_CPU] -add {RAMB18_X0Y60:RAMB18_X2Y93}
resize_pblock [get_pblocks pblock_CPU] -add {RAMB36_X0Y30:RAMB36_X2Y46}
set_property EXCLUDE_PLACEMENT 1 [get_pblocks pblock_CPU]

set_property DONT_TOUCH true [get_cells CPU_Comp]

# SET SENSOR PBLOCK
create_pblock pblock_SENSOR
add_cells_to_pblock [get_pblocks pblock_SENSOR] [get_cells sensor_top/sensor_gen[*].sensor/tdc0/*]
resize_pblock [get_pblocks pblock_SENSOR] -add {SLICE_X56Y200:SLICE_X101Y249}
set_property EXCLUDE_PLACEMENT 1 [get_pblocks pblock_SENSOR]

set_property LOC SLICE_X101Y210 [get_cells sensor_top/sensor_gen[1].sensor/tdc0/first_fine_carry]
set_property DONT_TOUCH true [get_cells sensor_top/sensor_gen[1].sensor/tdc0/*]
set_property LOC SLICE_X76Y210 [get_cells sensor_top/sensor_gen[2].sensor/tdc0/first_fine_carry]
set_property DONT_TOUCH true [get_cells sensor_top/sensor_gen[2].sensor/tdc0/*]
set_property LOC SLICE_X56Y210 [get_cells sensor_top/sensor_gen[3].sensor/tdc0/first_fine_carry]
set_property DONT_TOUCH true [get_cells sensor_top/sensor_gen[3].sensor/tdc0/*]
set_property LOC SLICE_X68Y210 [get_cells sensor_top/sensor_gen[4].sensor/tdc0/first_fine_carry]
set_property DONT_TOUCH true [get_cells sensor_top/sensor_gen[4].sensor/tdc0/*]
set_property LOC SLICE_X87Y210 [get_cells sensor_top/sensor_gen[5].sensor/tdc0/first_fine_carry]
set_property DONT_TOUCH true [get_cells sensor_top/sensor_gen[5].sensor/tdc0/*]


# PBLOCK FOR OTHER LOGIC
create_pblock others
resize_pblock [get_pblocks others] -add {SLICE_X0Y0:SLICE_X109Y134}
resize_pblock [get_pblocks others] -add {RAMB18_X0Y0:RAMB18_X6Y53}
resize_pblock [get_pblocks others] -add {RAMB36_X0Y0:RAMB36_X6Y26}
add_cells_to_pblock [get_pblocks others] [get_cells fifo*]
add_cells_to_pblock [get_pblocks others] [get_cells sensor_fifo*]
add_cells_to_pblock [get_pblocks others] [get_cells sensor_fifo/*]
add_cells_to_pblock [get_pblocks others] [get_cells lbus_if*]
add_cells_to_pblock [get_pblocks others] [get_cells lbus_if/*]
add_cells_to_pblock [get_pblocks others] [get_cells CPU_Comp/FSM*]
add_cells_to_pblock [get_pblocks others] [get_cells CPU_Comp/FSM/*]
add_cells_to_pblock [get_pblocks others] [get_cells sensor_top/sensor_gen[*].IDC*]
add_cells_to_pblock [get_pblocks others] [get_cells sensor_top/sensor_gen[*].IDF*]

# EMPTY PBLOCK
#create_pblock empty
create_pblock empty
resize_pblock [get_pblocks empty] -add {SLICE_X56Y135:SLICE_X101Y199}
resize_pblock [get_pblocks empty] -add {SLICE_X102Y135:SLICE_X109Y149}
resize_pblock [get_pblocks empty] -add {SLICE_X0Y135:SLICE_X55Y149}
resize_pblock [get_pblocks empty] -add {SLICE_X0Y150:SLICE_X19Y199}
resize_pblock [get_pblocks empty] -add {RAMB18_X0Y54:RAMB18_X6Y59}
resize_pblock [get_pblocks empty] -add {RAMB18_X3Y60:RAMB18_X5Y79}
resize_pblock [get_pblocks empty] -add {RAMB36_X0Y27:RAMB36_X6Y29}
resize_pblock [get_pblocks empty] -add {RAMB36_X3Y30:RAMB36_X5Y39}
set_property EXCLUDE_PLACEMENT 1 [get_pblocks empty]

#resize_pblock [get_pblocks others] -add {SLICE_X0Y100:SLICE_X109Y149}
#resize_pblock [get_pblocks others] -add {RAMB18_X0Y40:RAMB18_X6Y59}
#resize_pblock [get_pblocks others] -add {RAMB36_X0Y20:RAMB36_X6Y29}

# IGNORE TIMING IN SENSOR
#set_false_path -from [get_clocks sensor_clk_clk_wizard] -to [get_pins {sensor_top/sensor/tdc0/measurment_chain_regs[*].obs_regs/D}]
set_false_path -from [get_clocks sensor_clk_clk_wizard] -to [get_pins {sensor_top/sensor_gen[*].sensor/tdc0/measurment_chain_regs[*].obs_regs/D}]
