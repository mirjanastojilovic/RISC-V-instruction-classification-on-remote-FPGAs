...
add_files -fileset constrs_1 -norecurse "$src_path/constraints/pin_sasebo_giii_k7_Exp-IN.xdc"
import_files -fileset constrs_1 "$src_path/constraints/pin_sasebo_giii_k7_Exp-IN.xdc"
